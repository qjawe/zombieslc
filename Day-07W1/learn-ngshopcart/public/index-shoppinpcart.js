...
(function() {
  ...
  //  shopping CartApp
   var CartCtrl = function() {
       ...
       cartCtrl.removeFromBasket = function functionName(item) {
         var idx = 

       }

       _cartCtrl.addToBasket = function(){
           //validation items - add item to basket
           var idx = _cartCtrl.basket.findIndex(function(elem) {
             return (elem.item == _cartCtrl.item);
          });
          ...
          if (-1 ==idx) {
            ...
            _cartCtrl.basket.push({
             ...
             _cartCtrl.basket[idx].quantity += _cartCtrl.quantity;
          }
           //reset the model
           _cartCtrl.item = "";
           _cartCtrl.quantity = 0;
